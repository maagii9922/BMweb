# Generated by Django 3.1.2 on 2021-07-17 14:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbimage', models.ImageField(blank=True, null=True, upload_to='media/productthumb/', verbose_name='Зураг')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Тайлбар')),
                ('reg_user', models.IntegerField(verbose_name='Нэвтэрсэн хэрэглэгч')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hutlultName', models.CharField(max_length=300, verbose_name='Хөтлөлтийн нэр')),
            ],
            options={
                'verbose_name': 'Хөтлөлт',
                'verbose_name_plural': 'Хөтлөлт',
            },
        ),
        migrations.CreateModel(
            name='Manufacturer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('posCatName', models.CharField(max_length=300, verbose_name='Посын ангилал нэр')),
            ],
            options={
                'verbose_name': 'Посын ангилал',
                'verbose_name_plural': 'Посын ангилал',
            },
        ),
        migrations.CreateModel(
            name='ProdBrand',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pos', models.BooleanField(default=False, verbose_name='Посоор зарж болох эсэх')),
                ('thumbimage', models.ImageField(blank=True, null=True, upload_to='media/productthumb/', verbose_name='Зураг')),
                ...
                ('hemNegj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hemNegj', to='BMweb.hemnegj', verbose_name='Хэмжих нэгж')),
                ('hudNegj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hudNegj', to='BMweb.hemnegj', verbose_name='Худалдан авалтын нэгж')),
                ('hutlult', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BMweb.hutlult', verbose_name='Хөтлөлт')),
                ('paiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BMweb.paiz', verbose_name='Пайз')),
                ('posCat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='BMweb.poscategory', verbose_name='Посын ангилал')),
